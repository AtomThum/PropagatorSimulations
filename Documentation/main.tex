...
\DeclareMathOperator{\cov}{\symrm{Cov}}
\DeclareMathOperator{\corr}{\symrm{Corr}}
% Vector notations
...
\title{Dynamical analysis of interacting bipartite entangled systems via the Feynman path integral method}
\author{Puripat Thumbanthu \\ Advisor: Asst. Prof. Ekapong Hirunsirisawat, Dr. Tanapat Deesuwan}
...
\include{chapters/perturbationseriesposition}
\include{chapters/perturbationseriesmomentum}
