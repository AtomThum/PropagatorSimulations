...
\end{align}
The normalization factor are pulled out. From \cref{sec:table_of_gaussian_integrals}, both integrals in \cref{eq:spring_family_of_integrals} can be evaluated with
\begin{equation}
