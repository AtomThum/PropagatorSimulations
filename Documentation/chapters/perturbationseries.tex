...
\begin{equation}
    \braket{q}{\xi(t_0 = 0)} = \sqrt{\frac{1}{2\cpi\sigma}}\exp[\im p q - \frac{(q - s)^2}{4\sigma^2}]. \label{eq:unentangled_state}
\end{equation}
...
From the state given in \cref{eq:unentangled_state}, the state at any following time $t_F$ is given by
\begin{equation}
    \int K_0(q_F, q_F'; q_0, q_0'; t_F)
\end{equation}
